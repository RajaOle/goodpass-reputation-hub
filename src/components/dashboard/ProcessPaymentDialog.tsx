...
import { CheckCircle, Circle, AlertCircle, Upload, FileText, X } from 'lucide-react';
import { formatCurrency, getPaymentMethod, getOutstandingAmount, calculateInstallmentAmount, generateInstallments } from './payment/paymentUtils';
...
const ProcessPaymentDialog: React.FC<ProcessPaymentDialogProps> = ({
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setProofDocuments([...proofDocuments, ...validFiles]);
  };
